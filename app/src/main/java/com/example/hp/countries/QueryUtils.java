...
public final class QueryUtils {
    ...
    final private static String default_string = "Not Specified";
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem retrieving the Countries JSON results.", e);
        } finally {
    ...
    public static List<Country> extractFeatureFromJson(String CountryJSON) {
        ...
        try {
            JSONArray items = new JSONArray(CountryJSON);


            for (int i = 0; i < items.length(); i++) {
                JSONObject currentCountry = items.getJSONObject(i);
                ...
                if (name.length()>0 &&capital.length()>0 && flag.length()>0)
